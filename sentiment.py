...
with tabs[0]:
    ...
    wordcloud = WordCloud(width=800, height=400, background_color='black', colormap='coolwarm', font_path="/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf").generate(all_text)
    fig, ax = plt.subplots()
